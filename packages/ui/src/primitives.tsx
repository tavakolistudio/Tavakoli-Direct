...
>(({ className, ...props }, ref) => (
  <input
    ref={ref}
    className={cn(
      'focus:border-brand focus:ring-brand/30 h-11 w-full rounded-lg border border-neutral-300 bg-white px-3 text-sm text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:ring-2 disabled:opacity-60',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <textarea
    ref={ref}
    className={cn(
      'focus:border-brand focus:ring-brand/30 min-h-[90px] w-full rounded-lg border border-neutral-300 bg-white p-3 text-sm text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:ring-2',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <select
    ref={ref}
    className={cn(
      'focus:border-brand focus:ring-brand/30 h-11 w-full rounded-lg border border-neutral-300 bg-white px-3 text-sm text-neutral-900 focus:outline-none focus:ring-2',
      className,
    )}
    {...props}
  />
...
export function THead({
  ...
  return (
    <thead className={cn('border-b border-neutral-200 text-neutral-500', className)} {...props} />
  );
}
export function TR({
  className,
