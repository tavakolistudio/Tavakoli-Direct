...
/**
 * Map a DB automation (+trigger) to the pure-core AutomationDef consumed by the
 * evaluation engine. `capabilityAvailable` is supplied by the caller from the
 * account's ProviderCapability rows.
 */
