...
const HELP = [
  {
    icon: 'inbox',
    title: 'پنل کاربری سریع و روان',
    desc: 'با رابط کاربری ساده و حرفه‌ای، بدون پیچیدگی‌های اضافی، همه‌چیز را در یک نگاه ببینید. پیام‌های خودکار را مشاهده کنید و کنترل تمام مکالمات را به‌راحتی در دست داشته باشید.',
  },
  {
    icon: 'bolt',
    title: 'پاسخ‌دهی خودکار و هوشمند',
    desc: 'دیگر نیازی نیست ساعت‌ها در دایرکت وقت بگذارید! ربات‌های هوشمند، پیام‌های مشتریان را بر اساس کلمات کلیدی، نیازهای آن‌ها و رفتارشان پاسخ می‌دهند و ارتباطی مؤثر ایجاد می‌کنند.',
  },
  {
    icon: 'users',
    title: 'جمع‌آوری اطلاعات مشتریان',
    desc: 'با هر مکالمه، اطلاعات مهم مشتریان را به‌صورت خودکار ذخیره کنید و آن‌ها را برای پیشنهادهای بعدی هدف قرار دهید. شماره تماس، ایمیل، نوع نیاز مشتری و تاریخچهٔ مکالمات همیشه در دسترس شماست!',
  },
  {
    icon: 'chart',
    title: 'افزایش فروش با پیام‌های هوشمند و پیگیری خودکار',
    desc: 'به مشتریان پیشنهادهای ویژه بدهید، سبدهای خرید رهاشده را یادآوری کنید و با پاسخ‌های شخصی‌سازی‌شده، نرخ تبدیل فروش را چند برابر کنید!',
  },
  {
    icon: 'briefcase',
    title: 'پشتیبانی حرفه‌ای و سریع',
    desc: 'با یک تیم متخصص همیشه کنار شما هستیم! پشتیبانی ۲۴/۷ توکلی استودیو شما را در هر مرحله همراهی می‌کند تا تجربه‌ای بدون دغدغه داشته باشید.',
  },
  {
    icon: 'instagram',
    title: 'هماهنگی با الگوریتم‌های اینستاگرام',
    desc: 'با سیستم پیام‌رسانی هوشمند، پیام‌های شما به‌صورت هدفمند و بدون اسپم‌شدن ارسال می‌شوند تا همیشه در امنیت کامل فعالیت کنید و دچار بلاک یا محدودیت نشوید!',
  },
];
...
const PLAN_FEATURES = [
  'کامنت و دایرکت نامحدود',
  'دایرکت هوشمند',
  'کامنت هوشمند',
  'ویترین‌ساز',
  'فرم‌ساز',
  'دستیار هوش مصنوعی',
  'گزارش‌گیری حرفه‌ای پنل',
  'API',
];
